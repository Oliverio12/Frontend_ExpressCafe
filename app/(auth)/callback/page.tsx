    ...
    <Suspense
      fallback={
        <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#FEF5E7] to-[#F2C894] p-6 space-y-8">
          {/* Logo centrado */}
          <div
            className="flex items-center justify-center bg-grey/80 backdrop-blur-md rounded-full overflow-hidden shadow-md
          ...
          <div className="flex flex-col items-center">
            <div
              className="border-4 border-[#DCD1C1] border-t-4 border-t-[#E27A3F] rounded-full
